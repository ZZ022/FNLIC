...
def is_job_over(start_time: float, max_duration_job_min: int = 45000) -> bool:
...
class DescriptorOverfitter():
    ...
    # prior_coeffs: Optional[DescriptorNN] = None
...
POSSIBLE_Q_STEP = 2. ** torch.linspace(-16, 0, 17, device='cpu')
